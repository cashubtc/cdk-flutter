...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1406704506;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<AuthProof>> crateApiWalletMultiMintWalletGetUnspentAuthProofs(
      {required MultiMintWallet that, required String mintUrl});
  ...
  Future<List<AuthProof>> crateApiWalletMultiMintWalletMintBlindAuth(
      {required MultiMintWallet that,
  ...
  Future<void> crateApiWalletMultiMintWalletRefreshAccessToken(
      {required MultiMintWallet that, required String mintUrl});
  ...
  Future<void> crateApiWalletMultiMintWalletSetCat(
      {required MultiMintWallet that,
      required String mintUrl,
      required String cat});

  Future<void> crateApiWalletMultiMintWalletSetRefreshToken(
      {required MultiMintWallet that,
      required String mintUrl,
  ...
  DatabaseType crateApiWalletWalletDatabaseAutoAccessorGetBackendType(
      {required WalletDatabase that});

  String? crateApiWalletWalletDatabaseAutoAccessorGetPath(
      {required WalletDatabase that});

  String? crateApiWalletWalletDatabaseAutoAccessorGetUrl(
      {required WalletDatabase that});

  void crateApiWalletWalletDatabaseAutoAccessorSetBackendType(
      {required WalletDatabase that, required DatabaseType backendType});

  void crateApiWalletWalletDatabaseAutoAccessorSetPath(
      {required WalletDatabase that, String? path});

  void crateApiWalletWalletDatabaseAutoAccessorSetUrl(
      {required WalletDatabase that, String? url});

  bool crateApiWalletWalletDatabaseIsSqlite({required WalletDatabase that});

  bool crateApiWalletWalletDatabaseIsSupabase({required WalletDatabase that});
  ...
  Future<WalletDatabase> crateApiWalletWalletDatabaseNewSupabase(
      {required String url, required String apiKey});

  Future<WalletDatabase> crateApiWalletWalletDatabaseNewSupabaseWithOidc(
      {required String url,
  ...
  Future<void> crateApiWalletWalletDatabaseSetJwtToken(
      {required WalletDatabase that, String? token});

  Future<void> crateApiWalletWalletDatabaseSetRefreshToken(
      {required WalletDatabase that, String? token});

  Future<void> crateApiWalletWalletDatabaseSetTokenExpiration(
      {required WalletDatabase that, BigInt? expiration});
  ...
  Future<Mint?> crateApiWalletWalletFetchMintInfo({required Wallet that});
  ...
  Future<List<AuthProof>> crateApiWalletWalletGetUnspentAuthProofs(
      {required Wallet that});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<AuthProof>> crateApiWalletMultiMintWalletGetUnspentAuthProofs(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_auth_proof,
        decodeErrorData: sse_decode_error,
      ),
      constMeta: kCrateApiWalletMultiMintWalletGetUnspentAuthProofsConstMeta,
      argValues: [that, mintUrl],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiWalletMultiMintWalletGetUnspentAuthProofsConstMeta =>
          const TaskConstMeta(
            debugName: "MultiMintWallet_get_unspent_auth_proofs",
            argNames: ["that", "mintUrl"],
          );
  ...
  Future<List<AuthProof>> crateApiWalletMultiMintWalletMintBlindAuth(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletMultiMintWalletMintBlindAuthConstMeta,
      argValues: [that, mintUrl, amount],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletMultiMintWalletMintBlindAuthConstMeta =>
      const TaskConstMeta(
        debugName: "MultiMintWallet_mint_blind_auth",
        argNames: ["that", "mintUrl", "amount"],
      );
  ...
  Future<void> crateApiWalletMultiMintWalletRefreshAccessToken(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletMultiMintWalletRefreshAccessTokenConstMeta,
      argValues: [that, mintUrl],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletMultiMintWalletRefreshAccessTokenConstMeta =>
      const TaskConstMeta(
        debugName: "MultiMintWallet_refresh_access_token",
        argNames: ["that", "mintUrl"],
      );
  ...
  Future<void> crateApiWalletMultiMintWalletSetCat(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletMultiMintWalletSetCatConstMeta,
      argValues: [that, mintUrl, cat],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletMultiMintWalletSetCatConstMeta =>
      const TaskConstMeta(
        debugName: "MultiMintWallet_set_cat",
        argNames: ["that", "mintUrl", "cat"],
      );
  ...
  Future<void> crateApiWalletMultiMintWalletSetRefreshToken(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletMultiMintWalletSetRefreshTokenConstMeta,
      argValues: [that, mintUrl, refreshToken],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletMultiMintWalletSetRefreshTokenConstMeta =>
      const TaskConstMeta(
        debugName: "MultiMintWallet_set_refresh_token",
        argNames: ["that", "mintUrl", "refreshToken"],
      );
  ...
  DatabaseType crateApiWalletWalletDatabaseAutoAccessorGetBackendType(
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_database_type,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateApiWalletWalletDatabaseAutoAccessorGetBackendTypeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiWalletWalletDatabaseAutoAccessorGetBackendTypeConstMeta =>
          const TaskConstMeta(
            debugName: "WalletDatabase_auto_accessor_get_backend_type",
            argNames: ["that"],
          );
  ...
  String? crateApiWalletWalletDatabaseAutoAccessorGetUrl(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseAutoAccessorGetUrlConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseAutoAccessorGetUrlConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_auto_accessor_get_url",
        argNames: ["that"],
      );
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_Auto_RefMut_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletDatabase(
            that, serializer);
        sse_encode_database_type(backendType, serializer);
      ...
      constMeta:
          kCrateApiWalletWalletDatabaseAutoAccessorSetBackendTypeConstMeta,
      argValues: [that, backendType],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiWalletWalletDatabaseAutoAccessorSetBackendTypeConstMeta =>
          const TaskConstMeta(
            debugName: "WalletDatabase_auto_accessor_set_backend_type",
            argNames: ["that", "backendType"],
          );
  ...
  void crateApiWalletWalletDatabaseAutoAccessorSetUrl(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseAutoAccessorSetUrlConstMeta,
      argValues: [that, url],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseAutoAccessorSetUrlConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_auto_accessor_set_url",
        argNames: ["that", "url"],
      );
  ...
  bool crateApiWalletWalletDatabaseIsSqlite({required WalletDatabase that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseIsSqliteConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseIsSqliteConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_is_sqlite",
        argNames: ["that"],
      );
  ...
  bool crateApiWalletWalletDatabaseIsSupabase({required WalletDatabase that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseIsSupabaseConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseIsSupabaseConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_is_supabase",
        argNames: ["that"],
      );
  ...
  Future<WalletDatabase> crateApiWalletWalletDatabaseNewSupabase(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseNewSupabaseConstMeta,
      argValues: [url, apiKey],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseNewSupabaseConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_new_supabase",
        argNames: ["url", "apiKey"],
      );
  ...
  Future<WalletDatabase> crateApiWalletWalletDatabaseNewSupabaseWithOidc(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(url, serializer);
        sse_encode_String(apiKey, serializer);
        sse_encode_String(openidDiscovery, serializer);
      ...
      constMeta: kCrateApiWalletWalletDatabaseNewSupabaseWithOidcConstMeta,
      argValues: [url, apiKey, openidDiscovery, clientId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseNewSupabaseWithOidcConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_new_supabase_with_oidc",
        argNames: ["url", "apiKey", "openidDiscovery", "clientId"],
      );
  ...
  Future<void> crateApiWalletWalletDatabaseSetJwtToken(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseSetJwtTokenConstMeta,
      argValues: [that, token],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseSetJwtTokenConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_set_jwt_token",
        argNames: ["that", "token"],
      );
  ...
  Future<void> crateApiWalletWalletDatabaseSetRefreshToken(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletWalletDatabaseSetRefreshTokenConstMeta,
      argValues: [that, token],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseSetRefreshTokenConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_set_refresh_token",
        argNames: ["that", "token"],
      );
  ...
  Future<void> crateApiWalletWalletDatabaseSetTokenExpiration(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletDatabase(
            that, serializer);
        sse_encode_opt_box_autoadd_u_64(expiration, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiWalletWalletDatabaseSetTokenExpirationConstMeta,
      argValues: [that, expiration],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletDatabaseSetTokenExpirationConstMeta =>
      const TaskConstMeta(
        debugName: "WalletDatabase_set_token_expiration",
  ...
  Future<Mint?> crateApiWalletWalletFetchMintInfo({required Wallet that}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_mint,
        decodeErrorData: sse_decode_error,
      ),
      constMeta: kCrateApiWalletWalletFetchMintInfoConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletFetchMintInfoConstMeta =>
      const TaskConstMeta(
        debugName: "Wallet_fetch_mint_info",
        argNames: ["that"],
      );
  ...
  Future<List<AuthProof>> crateApiWalletWalletGetUnspentAuthProofs(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiWalletWalletGetUnspentAuthProofsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiWalletWalletGetUnspentAuthProofsConstMeta =>
      const TaskConstMeta(
        debugName: "Wallet_get_unspent_auth_proofs",
        argNames: ["that"],
      );
  ...
  AuthProof dco_decode_auth_proof(dynamic raw) {
    ...
    return AuthProof(
      keysetId: dco_decode_String(arr[0]),
      secret: dco_decode_String(arr[1]),
      c: dco_decode_String(arr[2]),
      y: dco_decode_String(arr[3]),
    );
  }
  ...
  List<AuthProof> dco_decode_list_auth_proof(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_auth_proof).toList();
  }
  ...
  Mint? dco_decode_opt_box_autoadd_mint(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_mint(raw);
  }
  ...
  AuthProof sse_decode_auth_proof(SseDeserializer deserializer) {
    ...
    return AuthProof(
        keysetId: var_keysetId, secret: var_secret, c: var_c, y: var_y);
  }
  ...
  Mint sse_decode_box_autoadd_mint(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_mint(deserializer));
  }
  ...
  List<AuthProof> sse_decode_list_auth_proof(SseDeserializer deserializer) {
    ...
    var ans_ = <AuthProof>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_auth_proof(deserializer));
    }
    return ans_;
  }
  ...
  Mint? sse_decode_opt_box_autoadd_mint(SseDeserializer deserializer) {
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_mint(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_box_autoadd_mint(Mint self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_mint(self, serializer);
  }
  ...
  void sse_encode_list_auth_proof(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_auth_proof(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_mint(Mint? self, SseSerializer serializer) {
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_mint(self, serializer);
    }
  }
...
class MultiMintWalletImpl extends RustOpaque implements MultiMintWallet {
  ...
  Future<List<AuthProof>> getUnspentAuthProofs({required String mintUrl}) =>
      RustLib.instance.api.crateApiWalletMultiMintWalletGetUnspentAuthProofs(
          that: this, mintUrl: mintUrl);
  ...
  Future<List<AuthProof>> mintBlindAuth(
      ...
      RustLib.instance.api.crateApiWalletMultiMintWalletMintBlindAuth(
          that: this, mintUrl: mintUrl, amount: amount);
  ...
  Future<void> refreshAccessToken({required String mintUrl}) =>
      RustLib.instance.api.crateApiWalletMultiMintWalletRefreshAccessToken(
          that: this, mintUrl: mintUrl);
  ...
  Future<void> setCat({required String mintUrl, required String cat}) =>
      RustLib.instance.api.crateApiWalletMultiMintWalletSetCat(
          that: this, mintUrl: mintUrl, cat: cat);
  ...
  Future<void> setRefreshToken(
      ...
      RustLib.instance.api.crateApiWalletMultiMintWalletSetRefreshToken(
          that: this, mintUrl: mintUrl, refreshToken: refreshToken);
...
class WalletDatabaseImpl extends RustOpaque implements WalletDatabase {
  ...
  DatabaseType get backendType => RustLib.instance.api
          .crateApiWalletWalletDatabaseAutoAccessorGetBackendType(
        that: this,
      );
  ...
  String? get url =>
      RustLib.instance.api.crateApiWalletWalletDatabaseAutoAccessorGetUrl(
        that: this,
      );

  set backendType(DatabaseType backendType) => RustLib.instance.api
      .crateApiWalletWalletDatabaseAutoAccessorSetBackendType(
          that: this, backendType: backendType);
  ...
  set url(String? url) => RustLib.instance.api
      .crateApiWalletWalletDatabaseAutoAccessorSetUrl(that: this, url: url);

  /// Check if this is a SQLite database
  bool isSqlite() => RustLib.instance.api.crateApiWalletWalletDatabaseIsSqlite(
        that: this,
      );

  /// Check if this is a Supabase database
  bool isSupabase() =>
      RustLib.instance.api.crateApiWalletWalletDatabaseIsSupabase(
        that: this,
      );
  ...
  Future<void> setJwtToken({String? token}) => RustLib.instance.api
      .crateApiWalletWalletDatabaseSetJwtToken(that: this, token: token);
  ...
  ///
  /// Returns an error if called on a non-Supabase database.
  Future<void> setRefreshToken({String? token}) => RustLib.instance.api
      .crateApiWalletWalletDatabaseSetRefreshToken(that: this, token: token);
  ...
  Future<void> setTokenExpiration({BigInt? expiration}) =>
      RustLib.instance.api.crateApiWalletWalletDatabaseSetTokenExpiration(
...
class WalletImpl extends RustOpaque implements Wallet {
  ...
  Future<Mint?> fetchMintInfo() =>
      RustLib.instance.api.crateApiWalletWalletFetchMintInfo(
        that: this,
      );
  ...
  Future<List<AuthProof>> getUnspentAuthProofs() =>
      RustLib.instance.api.crateApiWalletWalletGetUnspentAuthProofs(
        that: this,
      );
